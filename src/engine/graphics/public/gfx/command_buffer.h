...
class CommandBuffer
{
  ...
  public:
    ...
    virtual void draw_mesh(IMeshInterface* in_buffer, MaterialInstance* in_material, uint32_t instance_count = 1, uint32_t first_instance = 0)                                                                 = 0;
    virtual void draw_mesh(IMeshInterface* in_buffer, MaterialInstance* in_material, uint32_t first_index, uint32_t vertex_offset, uint32_t index_count, uint32_t instance_count = 1, uint32_t first_instance = 0) = 0;
    virtual void draw_mesh_indirect(IMeshInterface* in_buffer, MaterialInstance* in_material)                                                                                                                      = 0;
